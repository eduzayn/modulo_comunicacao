...
// Apply middleware
export const GET_enhanced = withMetrics(withLogging(GET, 'GET /api/channels/[id]'));
export const PUT_enhanced = withMetrics(withLogging(PUT, 'PUT /api/channels/[id]'));
export const DELETE_enhanced = withMetrics(withLogging(DELETE, 'DELETE /api/channels/[id]'));
