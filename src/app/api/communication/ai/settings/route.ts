 ...
 * 
 * @module app/api/communication/ai/settings
 * @author Devin AI
 * @created 2025-03-12
 */
...
// Apply middleware
export const GET_enhanced = withMetrics(withLogging(GET, 'GET /api/communication/ai/settings'));
export const PUT_enhanced = withMetrics(withLogging(PUT, 'PUT /api/communication/ai/settings'));
