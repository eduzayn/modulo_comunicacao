...
class ClientLogger {
   ...
   */
  setContext(context: Record<string, any>): ClientLogger {
   ...
   */
  child(childContext: Record<string, any>): ClientLogger {
...
export function withClientPerformanceLogging<T extends (...args: any[]) => any>(
  fn: T,
  label: string
